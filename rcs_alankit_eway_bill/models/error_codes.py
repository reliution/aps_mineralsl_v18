...
ERROR_CODES = {
    ...
    "115": _lt("Request payload data cannot be empty"),
    "116": _lt("Auth token is not valid for this client"),
    "117": _lt("This option is not enabled in Eway Bill 2"),
    ...
    "282": _lt("At least 4 digit HSN code is mandatory for taxpayers with turnover less than 5Cr."),
    "283": _lt("At least 6 digit HSN code is mandatory for taxpayers with turnover 5Cr. and above"),
    ...
    "444": _lt("This eway bill cannot be cancelled as it is generated from Eway Bill 1"),
    "445": _lt("This eway bill cannot be cancelled as it is generated from Eway Bill 2"),
    "446": _lt("Transport details cannot be updated here as it is generated from Eway Bill 1"),
    "447": _lt("Transport details cannot be updated here as it is generated from Eway Bill 2"),
    "448": _lt("Part B cannot be updated as this Ewaybill Part A is generated in Eway Bill 1"),
    "449": _lt("Part B cannot be updated as this Ewaybill Part A is generated in Eway Bill 2"),
    "450": _lt("For outward-export ewaybill, To GSTIN has to be either URP or SEZ"),
    "451": _lt("For inward-import ewaybill, From GSTIN has to be either URP or SEZ"),
    "452": _lt("Consolidate Ewaybill cannot be generated as this Ewaybill Part A is generated in Eway Bill 2"),
    ...
    "605": _lt("If the goods are moving towards transporter location, the value of toTransporterLoc should be Y"),
    "606": _lt("Vehicle type is mandatory, if the goods are moving to transporter place"),
    ...
    "653": _lt("The Ewaybill is cancelled"),
    ...
    "800": _lt("Redis server is not working, try after some time"),
