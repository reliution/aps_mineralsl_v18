...
class DiscussChannel(models.Model):
    # Support WhatsApp Channels, used for discussion with a specific whasapp number
    ...
    def _get_whatsapp_channel(self, whatsapp_number, wa_account_id, sender_name=False, create_if_not_found=False, related_message=False):
        ...
        # :param str whatsapp_number: whatsapp phone number of the customer. It should be formatted according to whatsapp standards, aka {country_code}{national_number}.
