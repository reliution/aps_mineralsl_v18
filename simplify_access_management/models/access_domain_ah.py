...
class access_domain_ah(models.Model):
    ...
    read_right = fields.Boolean(
        "Read",
        default=True,
        help="The set 'Read' access of the selected model for the specified users",
    )
    create_right = fields.Boolean(
        "Create",
        help="The set 'Create' access of the selected model for the specified users",
    )
    write_right = fields.Boolean(
        "Write",
        help="The set 'Write' access of the selected model for the specified users",
    )
    delete_right = fields.Boolean(
        "Delete",
        help="The set 'Delete' access of the selected model for the specified users",
    )
