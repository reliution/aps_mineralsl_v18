...
class hide_view_nodes(models.Model):
    ...
    btn_store_model_nodes_ids = fields.Many2many(
        "store.model.nodes",
        "btn_hide_view_nodes_store_model_nodes_rel",
        "hide_id",
        "store_id",
        string="Hide Button",
    ...
    page_store_model_nodes_ids = fields.Many2many(
        "store.model.nodes",
        "page_hide_view_nodes_store_model_nodes_rel",
        "hide_id",
        "store_id",
                        ...
                        if page_list:
                            for page in page_list:
                                if page.get("string"):
                                    ...
                                    store_model_nodes_id = store_model_nodes_obj.search(
                                        domain, limit=1
                                    )
                                ...
                                if setting_page.get("string"):
                                    ...
                                    if not store_model_nodes_id:
                                        store_model_nodes_obj.create(
                                            {
                                                "model_id": self.model_id.id,
                                                "attribute_name": setting_page.get(
                                                    "name"
                                                )
                                                or "",
                                                "attribute_string": setting_page.get(
                                                    "string"
                                                ),
                                                "node_option": "page",
                                                "lang_code": self.env.lang,
